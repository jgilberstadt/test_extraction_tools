...
#SBATCH -o /home/gilberstadt.j/Upload_from_Local/hd-bet_jobs/Sample_job.o%j
######## Job Error File: Sample_job.eJOBID ########
#SBATCH -e /home/gilberstadt.j/Upload_from_Local/hd-bet_jobs/Sample_job.e%j
######## Email
...
hd-bet -i ${fullpath} -o /scratch/gilberstadt.j/ADNI_data/hd-bet_output_test_bids/${fname}
